...
class ApplicationMain
{
   ...
   public static var winWidth:Float = 320;
   public static var winHeight:Float = 320;
   public static var winBackground:Int = 255;
   ...
   public static function main()
   {
      ...
      nme.app.Application.setPackage("fiveamigos", "Buffy", "org.fiveamigos.platformer", "1.0.0");
      ...
      else
      {
         wx.App.boot(function()
         {
            var size = { width: 320, height: 320 };
               ...
               frame = wx.Frame.create(null, null, "Buffy", null, size);
       ...
       ApplicationBoot.createInstance();
         ...
         var flags:Int = 
            ...
            (false ? nme.app.Application.RESIZABLE : 0) |
