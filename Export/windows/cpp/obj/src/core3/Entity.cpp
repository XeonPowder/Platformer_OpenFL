...
HX_STACK_THIS(this)
{
	...
	this->sprite = tmp3;
	HX_STACK_LINE(29)
	::openfl::display::Sprite tmp4 = this->sprite;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(29)
	::openfl::display::Graphics tmp5 = tmp4->get_graphics();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(29)
	tmp5->beginFill((int)16776960,(int)1);
	HX_STACK_LINE(30)
	::openfl::display::Sprite tmp6 = this->sprite;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(30)
...
Void Entity_obj::update( ){
{
		...
		this->yy = tmp17;
		HX_STACK_LINE(106)
		::openfl::display::Sprite tmp18 = this->sprite;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(106)
		Float tmp19 = this->xx;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(106)
		tmp18->set_x(tmp19);
		HX_STACK_LINE(107)
		::openfl::display::Sprite tmp20 = this->sprite;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(107)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::Sprite*/ ,(int)offsetof(Entity_obj,sprite),HX_HCSTRING("sprite","\x05","\xdc","\x95","\xc3")},
