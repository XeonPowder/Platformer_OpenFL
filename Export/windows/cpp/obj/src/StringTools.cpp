...
::String StringTools_obj::rpad( ::String s,::String c,int l){
	HX_STACK_FRAME("StringTools","rpad",0x27b4d7a5,"StringTools.rpad","C:\\HaxeToolkit\\haxe\\std/StringTools.hx",291,0xb9dbeb2d)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(c,"c")
	HX_STACK_ARG(l,"l")
	HX_STACK_LINE(292)
	...
	while((true)){
		...
		HX_STACK_LINE(296)
		::String tmp3 = (s + c);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(296)
		s = tmp3;
	}
	HX_STACK_LINE(298)
