...
Void Map_obj::__construct(Array< Float > _tileData,::nme::display::Tilesheet sheet)
{
...
HX_STACK_ARG(sheet,"sheet")
{
	...
	this->set_y((int)0);
	HX_STACK_LINE(14)
	::nme::display::Sprite tmp = ::nme::display::Sprite_obj::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(14)
	this->sprite = tmp;
	HX_STACK_LINE(15)
	::nme::display::MovieClip tmp1 = ::nme::Lib_obj::get_current();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(15)
	::nme::display::Sprite tmp2 = this->sprite;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(15)
	tmp1->addChild(tmp2);
	HX_STACK_LINE(16)
	this->sheet = sheet;
...
hx::ObjectPtr< Map_obj > Map_obj::__new(Array< Float > _tileData,::nme::display::Tilesheet sheet)
...
Void Map_obj::draw( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(22)
		::nme::display::Sprite tmp = this->sprite;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(22)
		::nme::display::Graphics tmp1 = tmp->get_graphics();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(22)
		tmp1->clear();
		HX_STACK_LINE(23)
		::nme::display::Tilesheet tmp2 = this->sheet;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(23)
		::nme::display::Sprite tmp3 = this->sprite;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(23)
		::nme::display::Graphics tmp4 = tmp3->get_graphics();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(23)
		Dynamic tmp5 = ((Dynamic)(this->tileData));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(23)
		tmp2->drawTiles(tmp4,tmp5,null(),null(),null());
	}
return null();
}
...
Dynamic Map_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"sheet") ) { sheet=inValue.Cast< ::nme::display::Tilesheet >(); return inValue; }
		break;
	case 6:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::nme::display::Tilesheet*/ ,(int)offsetof(Map_obj,sheet),HX_HCSTRING("sheet","\x9f","\xe2","\x1f","\x7c")},
	{hx::fsObject /*::nme::display::Sprite*/ ,(int)offsetof(Map_obj,sprite),HX_HCSTRING("sprite","\x05","\xdc","\x95","\xc3")},
