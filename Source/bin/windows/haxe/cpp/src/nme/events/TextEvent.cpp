...
{
HX_STACK_FRAME("nme.events.TextEvent","new",0xc3d81192,"nme.events.TextEvent.new","nme/events/TextEvent.hx",13,0xcadee83e)
HX_STACK_THIS(this)
...
::nme::events::Event TextEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.TextEvent","clone",0x265f850f,"nme.events.TextEvent.clone","nme/events/TextEvent.hx",20,0xcadee83e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(21)
	...
	HX_STACK_LINE(21)
	::nme::events::TextEvent tmp4 = ::nme::events::TextEvent_obj::__new(tmp,tmp1,tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(21)
	return tmp4;
}
...
::String TextEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.TextEvent","toString",0x66b6fa3a,"nme.events.TextEvent.toString","nme/events/TextEvent.hx",25,0xcadee83e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(26)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(26)
...
void TextEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.TextEvent","\xa0","\xa0","\xaf","\xe4");
