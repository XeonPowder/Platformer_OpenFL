...
{
HX_STACK_FRAME("nme.events.ProgressEvent","new",0xf84afc12,"nme.events.ProgressEvent.new","nme/events/ProgressEvent.hx",14,0x78a05dbe)
HX_STACK_THIS(this)
...
::nme::events::Event ProgressEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.ProgressEvent","clone",0x8d420f8f,"nme.events.ProgressEvent.clone","nme/events/ProgressEvent.hx",22,0x78a05dbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(23)
	...
	HX_STACK_LINE(23)
	int tmp3 = this->bytesLoaded;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(23)
	int tmp4 = this->bytesTotal;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(23)
	::nme::events::ProgressEvent tmp5 = ::nme::events::ProgressEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(23)
	return tmp5;
}
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.ProgressEvent","toString",0x8521ffba,"nme.events.ProgressEvent.toString","nme/events/ProgressEvent.hx",27,0x78a05dbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(28)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(28)
	::String tmp1 = (HX_HCSTRING("[ProgressEvent type=","\x75","\xe5","\x7d","\x04") + tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(28)
	...
	HX_STACK_LINE(28)
	int tmp14 = this->bytesTotal;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(28)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(ProgressEvent_obj,bytesLoaded),HX_HCSTRING("bytesLoaded","\xd0","\x66","\xca","\x99")},
	{hx::fsInt,(int)offsetof(ProgressEvent_obj,bytesTotal),HX_HCSTRING("bytesTotal","\x59","\x57","\xda","\x45")},
	{ hx::fsUnknown, 0, null()}
};
...
void ProgressEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.ProgressEvent","\x20","\x4b","\xbb","\x65");
