...
{
HX_STACK_FRAME("nme.events.ErrorEvent","new",0x2d9d0fd1,"nme.events.ErrorEvent.new","nme/events/ErrorEvent.hx",12,0x37224e9f)
HX_STACK_THIS(this)
...
::nme::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.ErrorEvent","clone",0x4a0fd10e,"nme.events.ErrorEvent.clone","nme/events/ErrorEvent.hx",18,0x37224e9f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
	...
	HX_STACK_LINE(19)
	::nme::events::ErrorEvent tmp5 = ::nme::events::ErrorEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(19)
	return tmp5;
}
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.ErrorEvent","toString",0xec94f79b,"nme.events.ErrorEvent.toString","nme/events/ErrorEvent.hx",23,0x37224e9f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(24)
...
void ErrorEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.ErrorEvent","\x5f","\xd3","\x6a","\x52");
