...
{
HX_STACK_FRAME("nme.events.KeyboardEvent","new",0xb30cc7d8,"nme.events.KeyboardEvent.new","nme/events/KeyboardEvent.hx",20,0x5cc3acb8)
HX_STACK_THIS(this)
...
::nme::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.KeyboardEvent","clone",0xd4e2d8d5,"nme.events.KeyboardEvent.clone","nme/events/KeyboardEvent.hx",35,0x5cc3acb8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
	...
	HX_STACK_LINE(36)
	::nme::events::KeyboardEvent tmp11 = ::nme::events::KeyboardEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,tmp9,tmp10);		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(36)
	return tmp11;
}
...
::String KeyboardEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.KeyboardEvent","toString",0xcba9c634,"nme.events.KeyboardEvent.toString","nme/events/KeyboardEvent.hx",40,0x5cc3acb8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(41)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(41)
...
void KeyboardEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.KeyboardEvent","\xe6","\x3b","\xee","\x72");
