...
{
HX_STACK_FRAME("nme.events.JoystickEvent","new",0x053bf923,"nme.events.JoystickEvent.new","nme/events/JoystickEvent.hx",23,0xd91d6dcd)
HX_STACK_THIS(this)
...
::nme::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.JoystickEvent","clone",0x763932e0,"nme.events.JoystickEvent.clone","nme/events/JoystickEvent.hx",36,0xd91d6dcd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
	...
	HX_STACK_LINE(37)
	::nme::events::JoystickEvent tmp8 = ::nme::events::JoystickEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(37)
	return tmp8;
}
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.JoystickEvent","toString",0xa88d0509,"nme.events.JoystickEvent.toString","nme/events/JoystickEvent.hx",41,0xd91d6dcd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(42)
...
void JoystickEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.JoystickEvent","\xb1","\x2b","\xa2","\xc8");
