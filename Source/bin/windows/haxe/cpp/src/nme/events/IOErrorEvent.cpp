...
{
HX_STACK_FRAME("nme.events.IOErrorEvent","new",0xf7d69377,"nme.events.IOErrorEvent.new","nme/events/IOErrorEvent.hx",10,0x80bfb9b9)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< IOErrorEvent_obj > _result_ = new IOErrorEvent_obj();
	_result_->__construct(inType,__o_bubbles,__o_cancelable,__o_text,__o_id);
	return _result_;}
...
::nme::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.IOErrorEvent","clone",0x386e0a34,"nme.events.IOErrorEvent.clone","nme/events/IOErrorEvent.hx",15,0x80bfb9b9)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16)
	...
	HX_STACK_LINE(16)
	::nme::events::IOErrorEvent tmp5 = ::nme::events::IOErrorEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(16)
	return tmp5;
}
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.IOErrorEvent","toString",0x933e7a35,"nme.events.IOErrorEvent.toString","nme/events/IOErrorEvent.hx",20,0x80bfb9b9)
	HX_STACK_THIS(this)
	HX_STACK_LINE(21)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(21)
...
void IOErrorEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.IOErrorEvent","\x05","\x0c","\x24","\xc7");
