...
{
HX_STACK_FRAME("nme.events.MouseEvent","new",0x76b611d4,"nme.events.MouseEvent.new","nme/events/MouseEvent.hx",48,0x6d6abdfc)
HX_STACK_THIS(this)
...
::nme::events::Event MouseEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.MouseEvent","clone",0xccef99d1,"nme.events.MouseEvent.clone","nme/events/MouseEvent.hx",64,0x6d6abdfc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(65)
	...
	HX_STACK_LINE(65)
	::nme::display::InteractiveObject tmp5 = this->relatedObject;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(65)
	...
	HX_STACK_LINE(65)
	::nme::events::MouseEvent tmp13 = ::nme::events::MouseEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,tmp9,tmp10,tmp11,tmp12);		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(65)
	return tmp13;
}
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::nme::display::InteractiveObject related,::nme::display::InteractiveObject targ){
	HX_STACK_FRAME("nme.events.MouseEvent","nmeCreateSimilar",0xa380c975,"nme.events.MouseEvent.nmeCreateSimilar","nme/events/MouseEvent.hx",77,0x6d6abdfc)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(78)
	::nme::display::InteractiveObject tmp6;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(78)
	if ((tmp5)){
		HX_STACK_LINE(78)
	...
	HX_STACK_LINE(78)
	::nme::events::MouseEvent tmp14 = ::nme::events::MouseEvent_obj::__new(tmp,tmp1,tmp2,tmp3,tmp4,tmp6,tmp7,tmp8,tmp9,tmp10,tmp11,tmp12,tmp13);		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(78)
	::nme::events::MouseEvent result = tmp14;		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(80)
	...
	result->stageY = tmp16;
	HX_STACK_LINE(83)
	bool tmp17 = (targ != null());		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(83)
	if ((tmp17)){
		HX_STACK_LINE(84)
		::nme::display::InteractiveObject tmp18 = targ;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(84)
		result->set_target(tmp18);
	}
	HX_STACK_LINE(86)
	::nme::events::MouseEvent tmp18 = result;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(86)
	return tmp18;
}
...
::String MouseEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.MouseEvent","toString",0xf2a6cab8,"nme.events.MouseEvent.toString","nme/events/MouseEvent.hx",90,0x6d6abdfc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(91)
	...
	HX_STACK_LINE(91)
	::nme::display::InteractiveObject tmp17 = this->relatedObject;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("nme.events.MouseEvent","updateAfterEvent",0x0fdae1d3,"nme.events.MouseEvent.updateAfterEvent","nme/events/MouseEvent.hx",95,0x6d6abdfc)
		HX_STACK_THIS(this)
	}
return null();
}
...
::nme::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,::cpp::Pointer< nme::Event > inEvent,::nme::geom::Point inLocal,::nme::display::InteractiveObject inTarget){
	HX_STACK_FRAME("nme.events.MouseEvent","nmeCreate",0x4d943b56,"nme.events.MouseEvent.nmeCreate","nme/events/MouseEvent.hx",68,0x6d6abdfc)
	HX_STACK_ARG(inType,"inType")
	...
	HX_STACK_LINE(70)
	int tmp5 = ::nme::events::MouseEvent_obj::efCtrlDown;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(70)
	...
	HX_STACK_LINE(70)
	int tmp9 = ::nme::events::MouseEvent_obj::efAltDown;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(70)
	...
	HX_STACK_LINE(70)
	int tmp13 = ::nme::events::MouseEvent_obj::efShiftDown;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(70)
	...
	HX_STACK_LINE(70)
	int tmp17 = ::nme::events::MouseEvent_obj::efLeftDown;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(70)
	int tmp18 = (int(tmp16) & int(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(70)
	bool tmp19 = (tmp18 != (int)0);		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(70)
	::nme::events::MouseEvent tmp20 = ::nme::events::MouseEvent_obj::__new(tmp1,true,true,tmp2,tmp3,null(),tmp7,tmp11,tmp15,tmp19,(int)0,null(),(int)0);		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(70)
	::nme::events::MouseEvent evt = tmp20;		HX_STACK_VAR(evt,"evt");
	HX_STACK_LINE(71)
	int tmp21 = inEvent->get_ref().x;		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(71)
	evt->stageX = tmp21;
	HX_STACK_LINE(72)
	int tmp22 = inEvent->get_ref().y;		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(72)
	evt->stageY = tmp22;
	HX_STACK_LINE(73)
	::nme::display::InteractiveObject tmp23 = inTarget;		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(73)
	evt->set_target(tmp23);
	HX_STACK_LINE(74)
	::nme::events::MouseEvent tmp24 = evt;		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(74)
	return tmp24;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::nme::display::InteractiveObject*/ ,(int)offsetof(MouseEvent_obj,relatedObject),HX_HCSTRING("relatedObject","\x0a","\xbf","\xcb","\xe8")},
...
void MouseEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.MouseEvent","\xe2","\xd7","\x33","\xfb");
