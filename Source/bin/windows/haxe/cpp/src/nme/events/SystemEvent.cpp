...
{
HX_STACK_FRAME("nme.events.SystemEvent","new",0xf6aa91d0,"nme.events.SystemEvent.new","nme/events/SystemEvent.hx",12,0x7d6881c0)
HX_STACK_THIS(this)
...
::nme::events::Event SystemEvent_obj::clone( ){
	HX_STACK_FRAME("nme.events.SystemEvent","clone",0x930110cd,"nme.events.SystemEvent.clone","nme/events/SystemEvent.hx",18,0x7d6881c0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
	...
	HX_STACK_LINE(19)
	::nme::events::ErrorEvent tmp4 = ::nme::events::ErrorEvent_obj::__new(tmp,tmp1,tmp2,null(),tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(19)
	return tmp4;
}
...
::String SystemEvent_obj::toString( ){
	HX_STACK_FRAME("nme.events.SystemEvent","toString",0x32f4d93c,"nme.events.SystemEvent.toString","nme/events/SystemEvent.hx",23,0x7d6881c0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(24)
...
void SystemEvent_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.events.SystemEvent","\xde","\xa9","\x71","\xc0");
