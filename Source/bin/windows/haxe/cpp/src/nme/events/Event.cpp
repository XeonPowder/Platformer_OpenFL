...
{
HX_STACK_FRAME("nme.events.Event","new",0xb8ecc67f,"nme.events.Event.new","nme/events/Event.hx",52,0x9f8d5ff1)
HX_STACK_THIS(this)
...
bool cancelable = __o_cancelable.Default(false);
{
	...
	HX_STACK_LINE(60)
	int tmp = ::nme::events::EventPhase_obj::AT_TARGET;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(60)
	this->_eventPhase = tmp;
}
;
	return null();
}
...
::nme::events::Event Event_obj::clone( ){
	HX_STACK_FRAME("nme.events.Event","clone",0x11bd0f3c,"nme.events.Event.clone","nme/events/Event.hx",64,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(65)
	...
	HX_STACK_LINE(65)
	::nme::events::Event tmp3 = ::nme::events::Event_obj::__new(tmp,tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(65)
	return tmp3;
}
...
bool Event_obj::nmeGetIsCancelled( ){
	HX_STACK_FRAME("nme.events.Event","nmeGetIsCancelled",0x76c8b896,"nme.events.Event.nmeGetIsCancelled","nme/events/Event.hx",68,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
	bool tmp = this->nmeIsCancelled;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(69)
	return tmp;
}
...
bool Event_obj::nmeGetIsCancelledNow( ){
	HX_STACK_FRAME("nme.events.Event","nmeGetIsCancelledNow",0xf8dbda20,"nme.events.Event.nmeGetIsCancelledNow","nme/events/Event.hx",72,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(73)
	bool tmp = this->nmeIsCancelledNow;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(73)
	return tmp;
}
...
{
		HX_STACK_FRAME("nme.events.Event","nmeSetPhase",0xb90f87be,"nme.events.Event.nmeSetPhase","nme/events/Event.hx",78,0x9f8d5ff1)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("nme.events.Event","stopImmediatePropagation",0x4cc10afe,"nme.events.Event.stopImmediatePropagation","nme/events/Event.hx",82,0x9f8d5ff1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(83)
		...
		if ((tmp)){
			HX_STACK_LINE(84)
			bool tmp1 = this->nmeIsCancelled = true;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(84)
			this->nmeIsCancelledNow = tmp1;
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("nme.events.Event","stopPropagation",0x47f2aa89,"nme.events.Event.stopPropagation","nme/events/Event.hx",88,0x9f8d5ff1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(89)
		bool tmp = this->get_cancelable();		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(89)
...
::String Event_obj::toString( ){
	HX_STACK_FRAME("nme.events.Event","toString",0x88aa4a2d,"nme.events.Event.toString","nme/events/Event.hx",94,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(95)
	::String tmp = this->get_type();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(95)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_FRAME("nme.events.Event","get_bubbles",0x7e0bc89d,"nme.events.Event.get_bubbles","nme/events/Event.hx",99,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(99)
	bool tmp = this->_bubbles;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(99)
	return tmp;
}
...
bool Event_obj::get_cancelable( ){
	HX_STACK_FRAME("nme.events.Event","get_cancelable",0x825c389e,"nme.events.Event.get_cancelable","nme/events/Event.hx",100,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(100)
	bool tmp = this->_cancelable;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(100)
	return tmp;
}
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_FRAME("nme.events.Event","get_currentTarget",0xd94d4e20,"nme.events.Event.get_currentTarget","nme/events/Event.hx",101,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
	Dynamic tmp = this->_currentTarget;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(101)
	return tmp;
}
...
Dynamic Event_obj::set_currentTarget( Dynamic v){
	HX_STACK_FRAME("nme.events.Event","set_currentTarget",0xfcbb262c,"nme.events.Event.set_currentTarget","nme/events/Event.hx",102,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(102)
...
int Event_obj::get_eventPhase( ){
	HX_STACK_FRAME("nme.events.Event","get_eventPhase",0xfc26ca4b,"nme.events.Event.get_eventPhase","nme/events/Event.hx",103,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(103)
	int tmp = this->_eventPhase;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(103)
	return tmp;
}
...
Dynamic Event_obj::get_target( ){
	HX_STACK_FRAME("nme.events.Event","get_target",0xe8a1fedb,"nme.events.Event.get_target","nme/events/Event.hx",104,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
	Dynamic tmp = this->_target;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(104)
	return tmp;
}
...
Dynamic Event_obj::set_target( Dynamic v){
	HX_STACK_FRAME("nme.events.Event","set_target",0xec1f9d4f,"nme.events.Event.set_target","nme/events/Event.hx",105,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(105)
	this->_target = v;
...
::String Event_obj::get_type( ){
	HX_STACK_FRAME("nme.events.Event","get_type",0x1cff27c4,"nme.events.Event.get_type","nme/events/Event.hx",106,0x9f8d5ff1)
	HX_STACK_THIS(this)
	HX_STACK_LINE(106)
...
Dynamic Event_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"target") ) { if (inCallProp != hx::paccNever) return get_target(); }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"bubbles") ) { if (inCallProp != hx::paccNever) return get_bubbles(); }
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"cancelable") ) { if (inCallProp != hx::paccNever) return get_cancelable(); }
		if (HX_FIELD_EQ(inName,"eventPhase") ) { if (inCallProp != hx::paccNever) return get_eventPhase(); }
	...
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"currentTarget") ) { if (inCallProp != hx::paccNever) return get_currentTarget(); }
		break;
	case 14:
...
bool Event_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"VIDEO_FRAME") ) { outValue = VIDEO_FRAME; return true;  }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"ADDED_TO_STAGE") ) { outValue = ADDED_TO_STAGE; return true;  }
		if (HX_FIELD_EQ(inName,"CONTEXT3D_LOST") ) { outValue = CONTEXT3D_LOST; return true;  }
...
Dynamic Event_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"target") ) { if (inCallProp != hx::paccNever) return set_target(inValue); }
		break;
	case 7:
	...
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"currentTarget") ) { if (inCallProp != hx::paccNever) return set_currentTarget(inValue); }
		break;
	case 14:
...
bool Event_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"VIDEO_FRAME") ) { VIDEO_FRAME=ioValue.Cast< ::String >(); return true; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"ADDED_TO_STAGE") ) { ADDED_TO_STAGE=ioValue.Cast< ::String >(); return true; }
		if (HX_FIELD_EQ(inName,"CONTEXT3D_LOST") ) { CONTEXT3D_LOST=ioValue.Cast< ::String >(); return true; }
...
void Event_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("_bubbles","\xe8","\x14","\x0f","\x9b"));
	outFields->push(HX_HCSTRING("_cancelable","\x33","\x6d","\x03","\x97"));
	outFields->push(HX_HCSTRING("_currentTarget","\xab","\x64","\x9b","\xa8"));
	outFields->push(HX_HCSTRING("_eventPhase","\xe0","\xfe","\xcd","\x10"));
	outFields->push(HX_HCSTRING("_target","\xf0","\x04","\x64","\xf5"));
	outFields->push(HX_HCSTRING("_type","\x99","\x0e","\x1a","\x00"));
	outFields->push(HX_HCSTRING("nmeIsCancelled","\xa1","\x57","\xdd","\x2e"));
	outFields->push(HX_HCSTRING("nmeIsCancelledNow","\xf5","\xf3","\x79","\xa5"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(Event_obj,_bubbles),HX_HCSTRING("_bubbles","\xe8","\x14","\x0f","\x9b")},
	{hx::fsBool,(int)offsetof(Event_obj,_cancelable),HX_HCSTRING("_cancelable","\x33","\x6d","\x03","\x97")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(Event_obj,_currentTarget),HX_HCSTRING("_currentTarget","\xab","\x64","\x9b","\xa8")},
	{hx::fsInt,(int)offsetof(Event_obj,_eventPhase),HX_HCSTRING("_eventPhase","\xe0","\xfe","\xcd","\x10")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(Event_obj,_target),HX_HCSTRING("_target","\xf0","\x04","\x64","\xf5")},
	{hx::fsString,(int)offsetof(Event_obj,_type),HX_HCSTRING("_type","\x99","\x0e","\x1a","\x00")},
	{hx::fsBool,(int)offsetof(Event_obj,nmeIsCancelled),HX_HCSTRING("nmeIsCancelled","\xa1","\x57","\xdd","\x2e")},
	{hx::fsBool,(int)offsetof(Event_obj,nmeIsCancelledNow),HX_HCSTRING("nmeIsCancelledNow","\xf5","\xf3","\x79","\xa5")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsString,(void *) &Event_obj::CONTEXT3D_LOST,HX_HCSTRING("CONTEXT3D_LOST","\x83","\xbd","\x42","\x45")},
	...
	{hx::fsString,(void *) &Event_obj::VIDEO_FRAME,HX_HCSTRING("VIDEO_FRAME","\xe9","\x79","\x25","\xe8")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static ::String sMemberFields[] = {
	HX_HCSTRING("_bubbles","\xe8","\x14","\x0f","\x9b"),
	HX_HCSTRING("_cancelable","\x33","\x6d","\x03","\x97"),
	HX_HCSTRING("_currentTarget","\xab","\x64","\x9b","\xa8"),
	HX_HCSTRING("_eventPhase","\xe0","\xfe","\xcd","\x10"),
	HX_HCSTRING("_target","\xf0","\x04","\x64","\xf5"),
	HX_HCSTRING("_type","\x99","\x0e","\x1a","\x00"),
	HX_HCSTRING("nmeIsCancelled","\xa1","\x57","\xdd","\x2e"),
	HX_HCSTRING("nmeIsCancelledNow","\xf5","\xf3","\x79","\xa5"),
	HX_HCSTRING("clone","\x5d","\x13","\x63","\x48"),
	HX_HCSTRING("nmeGetIsCancelled","\x37","\xea","\x34","\x0e"),
	HX_HCSTRING("nmeGetIsCancelledNow","\x1f","\xa3","\xcf","\x9a"),
	HX_HCSTRING("nmeSetPhase","\x9f","\xda","\x54","\x22"),
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("CONTEXT3D_LOST","\x83","\xbd","\x42","\x45"),
	...
	HX_HCSTRING("VIDEO_FRAME","\xe9","\x79","\x25","\xe8"),
	::String(null()) };

void Event_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("nme.events.Event","\x0d","\x1b","\x52","\x3b");
...
void Event_obj::__boot()
{
	...
	CONTEXT3D_LOST= HX_HCSTRING("context3DLost","\x64","\xe2","\x62","\x9b");
	...
	VIDEO_FRAME= HX_HCSTRING("videoFrame","\xb2","\xb5","\x51","\xe2");
}
