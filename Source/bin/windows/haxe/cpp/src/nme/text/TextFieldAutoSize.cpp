...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("nme.text.TextFieldAutoSize","\xc4","\x11","\x7c","\x1a"), hx::TCanCast< TextFieldAutoSize_obj >,sStaticFields,sMemberFields,
