...
{
HX_STACK_FRAME("nme.text.TextFormat","new",0xa4d89c4f,"nme.text.TextFormat.new","nme/text/TextFormat.hx",28,0x895409a1)
HX_STACK_THIS(this)
HX_STACK_ARG(in_font,"in_font")
HX_STACK_ARG(in_size,"in_size")
HX_STACK_ARG(in_color,"in_color")
HX_STACK_ARG(in_bold,"in_bold")
HX_STACK_ARG(in_italic,"in_italic")
HX_STACK_ARG(in_underline,"in_underline")
HX_STACK_ARG(in_url,"in_url")
HX_STACK_ARG(in_target,"in_target")
HX_STACK_ARG(in_align,"in_align")
HX_STACK_ARG(in_leftMargin,"in_leftMargin")
HX_STACK_ARG(in_rightMargin,"in_rightMargin")
HX_STACK_ARG(in_indent,"in_indent")
...
{  hx::ObjectPtr< TextFormat_obj > _result_ = new TextFormat_obj();
	_result_->__construct(in_font,in_size,in_color,in_bold,in_italic,in_underline,in_url,in_target,in_align,in_leftMargin,in_rightMargin,in_indent,in_leading);
	return _result_;}
...
void TextFormat_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.text.TextFormat","\xdd","\xc8","\x8a","\x95");
