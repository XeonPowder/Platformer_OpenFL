...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("nme.display.InterpolationMethod","\xb1","\xbd","\x82","\xed"), hx::TCanCast< InterpolationMethod_obj >,sStaticFields,sMemberFields,
