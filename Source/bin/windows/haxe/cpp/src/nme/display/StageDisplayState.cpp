...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("nme.display.StageDisplayState","\xd9","\x5b","\x07","\xc9"), hx::TCanCast< StageDisplayState_obj >,sStaticFields,sMemberFields,
