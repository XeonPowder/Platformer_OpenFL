...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("nme.utils.CompressionAlgorithm","\xce","\x79","\xa1","\x1c"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
