...
hx::Static(__mClass) = hx::RegisterClass(HX_HCSTRING("nme.net.URLLoaderDataFormat","\xaa","\xe8","\xb4","\xf2"), hx::TCanCast< URLLoaderDataFormat_obj >,sStaticFields,sMemberFields,
