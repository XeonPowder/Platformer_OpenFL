...
{
HX_STACK_FRAME("nme.net.URLVariables","new",0xa87ecbb3,"nme.net.URLVariables.new","nme/net/URLVariables.hx",8,0xb81838db)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("nme.net.URLVariables","decode",0xd26df7bb,"nme.net.URLVariables.decode","nme/net/URLVariables.hx",14,0xb81838db)
		HX_STACK_THIS(this)
...
::String URLVariables_obj::toString( ){
	HX_STACK_FRAME("nme.net.URLVariables","toString",0x7b34e879,"nme.net.URLVariables.toString","nme/net/URLVariables.hx",34,0xb81838db)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
void URLVariables_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.net.URLVariables","\x41","\x76","\x44","\x62");
