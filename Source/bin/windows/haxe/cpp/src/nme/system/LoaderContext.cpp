...
Void LoaderContext_obj::__construct(hx::Null< bool >  __o_checkPolicyFile,::nme::_system::ApplicationDomain applicationDomain,::nme::_system::SecurityDomain securityDomain)
{
HX_STACK_FRAME("nme.system.LoaderContext","new",0xd41035d7,"nme.system.LoaderContext.new","nme/system/LoaderContext.hx",14,0xcc444399)
HX_STACK_THIS(this)
...
bool checkPolicyFile = __o_checkPolicyFile.Default(false);
{
	...
	HX_STACK_LINE(18)
	bool tmp = (applicationDomain != null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(18)
	if ((tmp)){
		HX_STACK_LINE(20)
...
hx::ObjectPtr< LoaderContext_obj > LoaderContext_obj::__new(hx::Null< bool >  __o_checkPolicyFile,::nme::_system::ApplicationDomain applicationDomain,::nme::_system::SecurityDomain securityDomain)
...
Dynamic LoaderContext_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"securityDomain") ) { securityDomain=inValue.Cast< ::nme::_system::SecurityDomain >(); return inValue; }
		break;
	case 15:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"applicationDomain") ) { applicationDomain=inValue.Cast< ::nme::_system::ApplicationDomain >(); return inValue; }
		break;
	case 27:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::nme::_system::ApplicationDomain*/ ,(int)offsetof(LoaderContext_obj,applicationDomain),HX_HCSTRING("applicationDomain","\xb4","\x2c","\xdb","\xa3")},
	{hx::fsBool,(int)offsetof(LoaderContext_obj,checkPolicyFile),HX_HCSTRING("checkPolicyFile","\x76","\x1e","\x96","\xaf")},
	{hx::fsObject /*::nme::_system::SecurityDomain*/ ,(int)offsetof(LoaderContext_obj,securityDomain),HX_HCSTRING("securityDomain","\x24","\xd0","\x3f","\x66")},
	{ hx::fsUnknown, 0, null()}
};
...
void LoaderContext_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.system.LoaderContext","\x65","\xfe","\x84","\x34");
