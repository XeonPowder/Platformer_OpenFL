...
{
HX_STACK_FRAME("nme.media.ID3Info","new",0xb5aa46c6,"nme.media.ID3Info.new","nme/media/ID3Info.hx",16,0x607970ac)
HX_STACK_THIS(this)
{
}
;
...
void ID3Info_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("nme.media.ID3Info","\xd4","\x2b","\x0a","\x7e");
