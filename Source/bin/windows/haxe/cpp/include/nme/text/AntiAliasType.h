...
class AntiAliasType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("nme.text.AntiAliasType","\xef","\x00","\xcf","\xd8"); }
		::String __ToString() const { return HX_HCSTRING("AntiAliasType.","\xe6","\xaa","\xc6","\xbd") + tag; }
