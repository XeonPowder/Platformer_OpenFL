...
virtual Dynamic writeByte_dyn()=0;
		virtual Void writeBytes( ::nme::utils::ByteArray bytes,hx::Null< int >  offset,hx::Null< int >  length)=0;
...
class IDataOutput_delegate_ : public IDataOutput_obj
{
	...
	public:
		...
		Void writeBytes( ::nme::utils::ByteArray bytes,hx::Null< int >  offset,hx::Null< int >  length) { return mDelegate->writeBytes(bytes,offset,length);}
