...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/entity/hero/left_fall.png", "assets/entity/hero/left_fall.png");
		type.set ("assets/entity/hero/left_fall.png", AssetType.IMAGE);
		path.set ("assets/entity/hero/left_jump.png", "assets/entity/hero/left_jump.png");
		type.set ("assets/entity/hero/left_jump.png", AssetType.IMAGE);
		path.set ("assets/entity/hero/left_touchdown.png", "assets/entity/hero/left_touchdown.png");
		type.set ("assets/entity/hero/left_touchdown.png", AssetType.IMAGE);
		...
		path.set ("assets/entity/hero/right_fall.png", "assets/entity/hero/right_fall.png");
		type.set ("assets/entity/hero/right_fall.png", AssetType.IMAGE);
		path.set ("assets/entity/hero/right_jump.png", "assets/entity/hero/right_jump.png");
		type.set ("assets/entity/hero/right_jump.png", AssetType.IMAGE);
		path.set ("assets/entity/hero/right_touchdown.png", "assets/entity/hero/right_touchdown.png");
		type.set ("assets/entity/hero/right_touchdown.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/left_fall.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/left_jump.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/left_touchdown.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/right_fall.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/right_jump.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/entity/hero/right_touchdown.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
